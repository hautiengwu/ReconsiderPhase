...
[tfr, tfrtic, tfrsq, ConceFT, tfrsqtic] = ConceFT_STFT(xm, LowFrequencyLimit, HighFrequencyLimit, FrequencyAxisResolution, 1, WindowLength, NoWindowsInConceFT, WindowBandwidth, NoConceFT, 0, 0, 0) ;
...
imageSQ(t, tfrsqtic*SamplingRate, abs(tfrsq), .995) ; colormap(1-gray) ; title('SST') ;

figure ;
imageSQ(t, tfrsqtic*SamplingRate, abs(ConceFT), .995) ; colormap(1-gray) ; title('ConceFT') ;
